...
%Create a output CSV file for Kyle to analyze
  ...
  AllLabels = {'TradeDate','VX1','VX2','VX3','VX4','VX5','VX6','VX7','VX8','VX9','T1','T2','T3','T4','T5','T6','T7','T8','T9','AVCI','CONTANGO','CONTANGO2','CONTANGO30','CONTANGO_ROLL','ROLL_YIELD','S30VX','V_DELTA','V_RATIO','VCO','VIX','XIV','VXMT','VXST','VXV','VXST_ROLL','VXV_ROLL'};
  SmithLabels = {'TradeDate','VX1','VX2','VX3','CONTANGO','CONTANGO2','CONTANGO30','CONTANGO_ROLL','ROLL_YIELD','S30VX','T1','T2','T3'};
  
  AllParameters = [TdateNum,VX1,VX2,VX3,VX4,VX5,VX6,VX7,VX8,VX9,T1,T2,T3,T4,T5,T6,T7,T8,T9,AVCI,CONTANGO,CONTANGO2,CONTANGO30,CONTANGO_ROLL,ROLL_YIELD,S30VX,V_DELTA,V_RATIO,VCO,VIX,XIV,VXMT,VXST,VXV,VXST_ROLL,VXV_ROLL];
  ...
  SmithParameters = [TdateNum,VX1,VX2,VX3,CONTANGO,CONTANGO2,CONTANGO30,CONTANGO_ROLL,ROLL_YIELD,S30VX,T1,T2,T3];
  ...
  %
  fprintf(output_file_SmithParameters,'%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n', SmithParameters{1,:});
  for y = 2:length(SERIAL_DATE_DATA)
  fprintf(output_file_SmithParameters,'%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n', SmithParameters{y,:});
  end
